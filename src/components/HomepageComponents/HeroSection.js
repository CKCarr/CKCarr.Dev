...
export default function HeroSection() {
  return (
    <section id="home" className="hero pt-16  text-white">
      <div className="container mx-auto my-5 py-5">
        ...
        <div className="hero-header flex mx-4 justify-center items-center space-x-8">
          ...
          {/* Image 2 */}
          <img
            className="w-1/2 max-w-md img-fluid border-darkcyan"
            src={monitor}
        ...
        <div className="flex justify-center  mt-12">
          {/* Portfolio Button */}
          <button type="button" className="github-btn btn btn-md btn-info">
            <a href="/projects">
